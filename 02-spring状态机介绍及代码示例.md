...
先来解释什么是“状态”( State )。现实事物是有不同状态的，例如一个自动门，就有 open 和 closed 两种状态。我们通常所说的状态机是[有限状态机](https://so.csdn.net/so/search?q=%E6%9C%89%E9%99%90%E7%8A%B6%E6%80%81%E6%9C%BA&spm=1001.2101.3001.7020)，也就是被描述的事物的状态的数量是有限个，例如自动门的状态就是两个 open 和 closed 。

![spring状态机介绍及spring-statemachine代码示例_算法](https://i-blog.csdnimg.cn/img_convert/b767a1eea813d57da5f16f37a66f41de.jpeg "img")

状态机，也就是 State Machine ，不是指一台实际机器，而是指一个数学模型。说白了，一般就是指一张[状态转换图](https://so.csdn.net/so/search?q=%E7%8A%B6%E6%80%81%E8%BD%AC%E6%8D%A2%E5%9B%BE&spm=1001.2101.3001.7020)。例如，根据自动门的运行规则，我们可以抽象出下面这么一个图。
...
这样状态机的基本定义我们就介绍完毕了。重复一下：状态机是有限状态自动机的简称，是现实事物运行规则抽象而成的一个[数学模型](https://so.csdn.net/so/search?q=%E6%95%B0%E5%AD%A6%E6%A8%A1%E5%9E%8B&spm=1001.2101.3001.7020)。
...
![spring状态机介绍及spring-statemachine代码示例_sed_02](https://i-blog.csdnimg.cn/img_convert/b5932c46333c446b3c8b3f3d6b1110fe.jpeg "img")
...
![spring状态机介绍及spring-statemachine代码示例_java_03](https://i-blog.csdnimg.cn/img_convert/3b7ab8aae127339434b0ed8f73e2e14e.jpeg "img")
...
![spring状态机介绍及spring-statemachine代码示例_java_04](https://i-blog.csdnimg.cn/img_convert/fd64e436b48b9ad75f99444795fb25db.jpeg "img")

监听线程：

![spring状态机介绍及spring-statemachine代码示例_sed_05](https://i-blog.csdnimg.cn/img_convert/08e02d0044a8ad3be990259988c2855d.jpeg "img")
...
本文转自 <https://blog.csdn.net/qq_35485206/article/details/148152939>，如有侵权，请联系删除。
